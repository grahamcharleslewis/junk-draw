...
class WeeksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create week" do
    assert_difference("Week.count") do
      post weeks_url, params: { week: { date_commencing: @week.date_commencing, week_no: @week.week_no } }
    end
  ...
  test "should update week" do
    patch week_url(@week), params: { week: { date_commencing: @week.date_commencing, week_no: @week.week_no } }
